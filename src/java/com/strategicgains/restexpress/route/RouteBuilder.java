...
public abstract class RouteBuilder {
    ...
    public List<Route> build() {
        ...
        for (HttpMethod method : methods) {
            ...
            routes.add(newRoute(pattern, controller, action, method, shouldSerializeResponse, name, supportedFormats,
                    defaultFormat, flags, parameters, baseUrl, supportMultipart));
        }
